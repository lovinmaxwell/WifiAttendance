...
<head>
        ...
        <meta charset="utf-8" />
        <title>Complete Admin : Form Components - Datepicker</title>
    ...
    <section class="box ">
        ...
        <div class="col-lg-12">
            ...
            <div class="form-group">
                ...
                <div class="controls">
					<form method="post" action="datepic1.php">
                    <input type="text" class="form-control datepicker" name="n1"  data-date-format='yyyy-mm-dd' value="">
					<input type="submit">
					</form>
                </div>
            </div>
...
$sql="SELECT t1.ID,t1.employee_name,t1.MAC_ID,t2.MAC,min(t2.time) as check_in,max(t2.Time) as check_out,TIMEDIFF(max(t2.Time),min(t2.time)) as hours_present, IF(TIME_TO_SEC(TIMEDIFF(max(t2.Time),min(t2.time)))>=28800,'Present','Absent') as Attendence_Status
         FROM registration t1,wifi_rissi_mac t2
		  where t1.MAC_ID=t2.MAC and date(t2.time)='$mysqldate' group by t1.ID";
...
<script src="../../assets/plugins/jquery-ui/smoothness/jquery-ui.min.js" type="text/javascript"></script> <script src="../assets/plugins/datepicker/js/datepicker.js" type="text/javascript"></script> 
