  ...
  <?php $pid=$rows['MAC_ID'];  ?>
	<tbody>
     ...
     <td bgcolor="#Fdf5e6"><b><font color='#000080'>  <?php echo $rows['check_out'];?> </font></b></td>
	  ...
	  <td bgcolor="#Fdf5e6"><b><font color='#000080'>   <?php echo '<a href="' . htmlspecialchars("presentdatedetails.php?id=".html_entity_decode($pid)) .'&dat=' . html_entity_decode($selectdate). '" >details </a>';?></font></b></td>
	  
	  <!-- <td bgcolor="#Fdf5e6"><b><font color='#000080'>  <a href="/wifidemo.v2/default/graph/presentdatedetails.php?id ="""> details </a></font></b></td> -->
