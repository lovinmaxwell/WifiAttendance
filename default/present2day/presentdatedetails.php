...
<html>
   ...
   <body style="background-color:''"></style>
	<input type="submit" name="submit" value="BACK" onclick="location.href='tables-editable.php'">
  	<?php 
 //session_start();
...
//$id=isset($_GET['id']) ? $_GET['id'] : '';
	...
	$dat=$_GET["dat"];
     	...
     	$strQuery ="SELECT ABS(RSSI) As RISSI ,Time FROM wifi_rissi_mac WHERE MAC='$id' and date(Time)='$dat'";
